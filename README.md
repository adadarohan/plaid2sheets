...
1. Create a [plaid developer account](https://my.plaid.com/sign-up), request production access and get your client ID and secret. I was able to get approved for production access by answering all security / compliance questions with the fact that this is only for personal use.

Activate the `transactions` product.
